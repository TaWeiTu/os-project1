...
asmlinkage long sys_gettime(struct timespec64 __user *ts);
asmlinkage long sys_printtime(pid_t pid, struct timespec64 __user *start, struct timespec64 __user *end);
